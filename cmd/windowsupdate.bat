<# ::
@echo off
title // WINDOWS UPDATE CONTROL - AuroraTOOLKIT - HINZDC X SARGA
...
Clear-Host
$Host.UI.RawUI.WindowTitle = '> WINDOWS UPDATE CONTROL - AuroraTOOLKIT - HINZDC X SARGA'
#$Host.UI.RawUI.BufferSize = New-Object System.Management.Automation.Host.Size(125, 32)
$Host.UI.RawUI.WindowSize = New-Object System.Management.Automation.Host.Size(125, 32)
# ================================
