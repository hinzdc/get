...
@echo.
@echo   ùù                                    ùù 
@echo   ù?ùùùùùù ùù ùùùùù?ù ùùùùùùù   ùùù?ùùù ùùùùùùù
@echo   ùù     ùù          ùù    ùùùù   ùù    ùù ùù
@echo   ùù     ùù ùù ùù    ùù ùùùù      ùù    ùù ùù
@echo   ùù     ùù ùù ùù    ùù ùùùùùùù   ùùùùùùùù ùùùùùùù
echo ----------------------------------------------------------------------------------------------------
